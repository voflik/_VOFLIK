...
Paysafe_SDCaller_Utils.prototype = {
	...
	getMyVendor: function (vend) {
		...
		try {
			...
			var x2 = x.addOrCondition('u_secondary',cleanVend);
			var x3 = x2.addOrCondition('u_email', vend);
			var x4 = x3.addOrCondition('u_email_2', vend);
			var x5 = x4.addOrCondition('u_email_3', vend);
			var x6 = x5.addOrCondition('u_domain', mail);
