		...
		if(dev.next()){
			...
			if(zionPlatSplit.length > 0 || zionMicroSplit.length > 0 ||  maprPlatSplit.length > 0 || maprMicroSplit.length > 0){
				...
				for(i=0; i<zionPlatSplit.length; i++){
					child.initialize();
					child.u_description = '<b>' + getDisplayVal('u_cmdb_ci_appl_zion_platform', zionPlatSplit[i], 'name') +  getDisplayVal('u_cmdb_ci_appl_zion_platform', zionPlatSplit[i], 'version') + '</b>' + '<hr>' + '<br>' + 'Parent Change is: ' + current.number + '<br>' + desc;
					child.short_description = getDisplayVal('u_cmdb_ci_appl_zion_platform', zionPlatSplit[i], 'name') + getDisplayVal('u_cmdb_ci_appl_zion_platform', zionPlatSplit[i], 'version') + ' - ' + sDesc;
				...
				for(r=0; r<maprPlatSplit.length; r++){
					child.initialize();
					child.u_description = '<b>' + getDisplayVal('u_cmdb_ci_appl_mapr_crud', maprPlatSplit[r], 'name') + getDisplayVal('u_cmdb_ci_appl_mapr_crud', maprPlatSplit[r], 'version') + '</b>' + '<hr>' + '<br>' + 'Parent Change is: ' + current.number + '<br>' + desc;
					child.short_description = getDisplayVal('u_cmdb_ci_appl_mapr_crud', maprPlatSplit[r], 'name') + getDisplayVal('u_cmdb_ci_appl_mapr_crud', maprPlatSplit[r], 'version') + ' - ' + sDesc;
				...
				for(j=0; j<maprMicroSplit.length; j++){
					child.initialize();
					child.u_description = '<b>' + getDisplayVal('u_cmdb_ci_appl_mapr_platform', maprMicroSplit[j], 'name') + getDisplayVal('u_cmdb_ci_appl_mapr_platform', maprMicroSplit[j], 'version') + '</b>' + '<hr>' + '<br>' + 'Parent Change is: ' + current.number + '<br>' + desc;
					child.short_description = getDisplayVal('u_cmdb_ci_appl_mapr_platform', maprMicroSplit[j], 'name') + getDisplayVal('u_cmdb_ci_appl_mapr_platform', maprMicroSplit[j], 'version') + ' - ' + sDesc;
